export const creditAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'uint256', name: 'typeid', type: 'uint256' }],
    name: 'RemovedAsset',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    name: '_storage',
    outputs: [{ internalType: 'contractData', name: '', type: 'address' }],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'bytes32', name: '_memo', type: 'bytes32' },
    ],
    name: 'lock',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'string', name: '_partnerIssuer', type: 'string' },
    ],
    name: 'add',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [],
    name: 'getAssetIds',
    outputs: [{ internalType: 'uint256[]', name: 'assetIds', type: 'uint256[]' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
